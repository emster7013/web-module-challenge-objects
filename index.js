...
console.log(createMenuItem('Bacon Cheese Burger', 7,'Lunch'));
console.log(createMenuItem('Mocha Hazelnut Supreme', 2.50,'snack'));
console.log(createMenuItem('Mint Mocha Cappuccino', 4.50,'Hot Drink'));
...
reviews.push({name: 'Emily', rating: 1.5, feedback: 'Honestly, the food was trash'});
console.log(reviews);
